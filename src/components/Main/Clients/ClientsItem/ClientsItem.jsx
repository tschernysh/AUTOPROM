    ...
    return(
        <div className={s.mainPage__OurClientsrecommend_element}>
            ...
            <div className={s.mainPage__OurClientsrecommend_element_content}>
                <div onClick={() => history.push('/product')} className={s.mainPage__OurClientsrecommend_element_content_title}>OBDII сканер KONNWEI
                </div>
                <div draggable={'false'}  className={s.mainPage__OurClientsrecommend_element_content_comment}>
                    <img src={Star} alt=""/>
                ...
                <img draggable={'false'} src={OurClientsRecommend} alt=""/>
